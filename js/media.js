...
function calcularMedia() {
  ...
  if (media === 0) {
    ...
    mensagem = "Nota inválida. Insira notas de 0 a 10.";
  }

  // Exibir o resultado na página HTML
  const resultadoElement = document.getElementById('resultadoMedia');
...
btnSituacao.addEventListener('click', calcularMedia);
